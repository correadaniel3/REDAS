...
dhbgApp.mobile.start = function() {
        ...
        $('menu >item').each(function() {
            ...
            if($subitems.length > 0) {
                ...
                $subitems.each(function() {
                    var $this = $(this);
                    var $subitem = $('<li class="button middle-child subitem" page="' + $this.attr('data-page') + '">' + $this.attr('title') + '</li>');
                    
                    
                    
                    $litem.append($subitem);
                });
            }
            else {
       ...
       //Tabs menu
        ...
        dhbgApp.pages[dhbgApp.pages.length] = {'id': 'bibliography', 'subpages': 1, 'title': 'Bibliografía'};
        dhbgApp.pages[dhbgApp.pages.length] = {'id': 'credits', 'subpages': 1, 'title': 'Créditos'};
...
dhbgApp.mobile.load_operations = function() {
    ...
    dhbgApp.actions.autoLoadSounds = function ($parent) {
        ...
        $parent.find('[data-sound]').each(function(){
            ...
            $this.on('click', function() {
                dhbgApp.DB.loadSound.setAttribute('src', 'content/sounds/' + $this.attr('data-sound') + '.mp3');
    ...
    dhbgApp.actions.activityDroppable = function ($this) {
        ...
        var activityOptions={
            ...
            'draggableContainer': $('#dialog_content')
        };
